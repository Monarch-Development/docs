...
- ElevatorOptions: `table`
  - Options of the elevator, see ElevatorOptions below
...
- floors: `table`
  - Floors of the elevator, see floors below
...
- FloorOptions: `table`
  - Options of the floor, see FloorOptions below
...
- zones: `table`
  - Zones of the floor, see zones below
- locked?: `boolean`
...
- zoneData: `table`
  - Data of the zone, see zoneData below
