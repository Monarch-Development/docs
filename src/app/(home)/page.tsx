...
const teamMembers = [
  { name: 'IlMelons', role: 'Owner', avatar: 'https://img.monarch-docs.ricodev.it/Melons.webm?v=2' },
  { name: 'Rico', role: 'Owner', avatar: 'https://img.monarch-docs.ricodev.it/Rico.webm?v=2' },
